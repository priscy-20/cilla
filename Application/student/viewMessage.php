    ...
    <body style="overflow-x:hidden">
        ...
        <div class="container">
            ...
            <ul class="nav nav-tabs">
                <li class="active"><a data-toggle="tab" href="#table">Message</a></li>
                        ...
                        <table class="table" style="width: 800px;">
                            ...
                            <tbody>
                                ...
                                <?php
                                    ...
                                    $query = "select * from remarking join messageteacher_tb on messageteacher_tb.to_msgT = remarking.remarks where student_id = '$student_id';";
